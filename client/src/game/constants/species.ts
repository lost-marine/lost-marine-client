...
export const speciesMap: Map<SpeciesId, Species> = new Map<SpeciesId, Species>([
  ...
  [
    4,
    {
      ...
      evolutionList: [6, 7],
      tierCode: 2,
      spritesheetUrl: "assets/sprites/PennantCoralFish.png",
      baseSpriteUrl: "assets/sprites/base/PennantCoralFish.png",
      frameStart: 0,
      frameEnd: 8,
  ...
  [
    6,
    {
      ...
      evolutionList: [11],
      tierCode: 3,
      spritesheetUrl: "assets/sprites/SeaTurtle.png",
      baseSpriteUrl: "assets/sprites/base/SeaTurtle.png",
      frameStart: 0,
      frameEnd: 3,
